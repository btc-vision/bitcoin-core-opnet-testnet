...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-maxstandardtxweight=<n>", strprintf("Set maximum standard transaction weight for relay and mining (default: %d)", DEFAULT_MAX_STANDARD_TX_WEIGHT), ArgsManager::ALLOW_ANY, OptionsCategory::NODE_RELAY);
