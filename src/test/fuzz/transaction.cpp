...
FUZZ_TARGET(transaction, .init = initialize_transaction)
{
    ...
    std::string reason;
    const bool is_standard_with_permit_bare_multisig = IsStandardTx(tx, DEFAULT_MAX_STANDARD_TX_WEIGHT, std::nullopt, /* permit_bare_multisig= */ true, dust_relay_fee, reason);
    const bool is_standard_without_permit_bare_multisig = IsStandardTx(tx, DEFAULT_MAX_STANDARD_TX_WEIGHT, std::nullopt, /* permit_bare_multisig= */ false, dust_relay_fee, reason);
